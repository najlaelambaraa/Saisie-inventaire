...
@Component({
  ...
  <div class="grid grid-flow-col justify-stretch">
    <div class="flex flex-1">
      <button class="flex-1 bg-orange-400 hover:bg-orange-200 text-white font-bold py-2 px-4 rounded mr-2" (click)="button = 'Saisie'">Saisie</button>
      <button class="flex-1 bg-orange-400 hover:bg-orange-200 text-white font-bold py-2 px-4 rounded"(click)="button = 'Inventaire'">Inventaire</button>
    </div>
  </div>
